  ...
  const stepsData = [
    {
      ...
      description:
        "Tell Zendra what you need—a resume, report, or proposal. Be as detailed as you'd like.",
      benefits: [
      ],
    },
    {
      icon: <Layers className="h-6 w-6" />,
      title: "AI Creates Your PDF",
      description:
        "Our AI generates a professional document in seconds, formatted and ready to use.",
      benefits: [
      ],
    },
    {
      ...
      title: "Edit & Perfect",
      description:
        "Click any section to refine with AI. Download as PDF or Word when you're satisfied.",
      benefits: [
      ],
    },
  ];
